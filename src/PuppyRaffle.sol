...
// @written use of floating pragma is bad
// @written why use 0.7.6?
...
contract PuppyRaffle is ERC721, Ownable {
    ...
    function enterRaffle(address[] memory newPlayers) public payable {
        ...
        // written-skip if it's an empty array, we still emit the event?
    ...
    function getActivePlayerIndex(
        ...
        // @written if the player is at index 0, it will return 0 and the player might think they are not active!
        return 0;
    }
    ...
    function selectWinner() external {
        ...
        // written-skip why not just do address(this).balance?
    ...
    function withdrawFees() external {
        // written-skip mishandling of ETH
        require(
    ...
    // written-skip this isn't used anywhere
